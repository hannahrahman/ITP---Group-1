...
export default class EditMiscellaneousComplain extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost:5000/miscComplains/edit/'+this.props.match.params.id)
        .then(res => {
            this.setState({
                ...
                dateofincident: res.data.dateofincident,
  ...
  onSubmit(e) {
    ...
    axios
        .post('http://localhost:5000/miscComplains/update/'+this.props.match.params.id, complain)
